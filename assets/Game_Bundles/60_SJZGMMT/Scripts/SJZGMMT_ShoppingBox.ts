...
@ccclass('SJZGMMT_ShoppingBox')
export class SJZGMMT_ShoppingBox extends Component {
    ...
    Init(Name: string, State: number = 0) {
        ...
        SJZGMMT_Incident.LoadSprite(`Sprites/黑市/${this.kuanSpriteName[Propdata.quality]}`).then((sp: SpriteFrame) => {
