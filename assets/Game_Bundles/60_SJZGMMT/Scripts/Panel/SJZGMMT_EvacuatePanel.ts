...
@ccclass('SJZGMMT_EvacuatePanel')
export class SJZGMMT_EvacuatePanel extends PanelBase {
    Show(...args: any[]): void {
    ...
    OnButtonClick(event: EventTouch) {
        ...
        switch (event.target.name) {
            case "关闭":
                SJZGMMT_UIManager.Instance.HidePanel(SJZGMMT_Constant.Panel.EvacuatePanel);
                break;
            case "撤离":
