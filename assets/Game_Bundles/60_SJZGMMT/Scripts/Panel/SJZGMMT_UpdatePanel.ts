...
@ccclass('SJZGMMT_UpdatePanel')
export class SJZGMMT_UpdatePanel extends PanelBase {
    ...
    private UpdateData: { Title: string, Content: string }[] = [
        { Title: "2月6日更新公告", Content: "1.笔记上线！珍惜物品等你来收集\n2.新增黑市神话武器特效\n3.新增大红[青铜鼎][狗头铜首][黄金怀表]\n4.地图外景全面翻新！" }
    ]
    ...
    OnExitClick() {
        SJZGMMT_UpdatePanel.IsOnceShow = true;
        SJZGMMT_UIManager.Instance.HidePanel(SJZGMMT_Constant.Panel.UpdatePanel);
    }
}
