...
export class Joystick extends Component {
    ...
    OnTouchMove(event: EventTouch) {
        ...
        for (let i = 0; i < touches.length; ++i) {
            ...
            if (this._movementTouch && touch.getID() == this._movementTouch.getID()) {
                ...
                CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_MOVEMENT, dirX, dirY, len / radius);
            }
        }
    }
    ...
    OnTouchEnd(event: EventTouch) {
        ...
        for (let i = 0; i < touches.length; ++i) {
            ...
            if (this._movementTouch && touch.getID() == this._movementTouch.getID()) {
                ...
                CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_MOVEMENT, 0, 0, 0);
    ...
    OnAttackTouchMove(event: EventTouch) {
        ...
        for (let i = 0; i < touches.length; ++i) {
            ...
            if (this._attackMovementTouch && touch.getID() == this._attackMovementTouch.getID()) {
                ...
                CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_ATTACK_START, dirX, dirY);
            }
        }
    }
    ...
    OnAttackTouchEnd(event: EventTouch) {
        ...
        for (let i = 0; i < touches.length; ++i) {
            ...
            if (this._attackMovementTouch && touch.getID() == this._attackMovementTouch.getID()) {
                ...
                CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_ATTACK_END);
            }
        }
    }

    // onReloadTouchEnd(event: EventTouch) {
    //     CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_JUMP);
    // }
    ...
    updateDir() {
        ...
        CDXX_EventManager.Scene.emit(CDXX_MyEvent.CDXX_MOVEMENT, this._dir.x, this._dir.y, 1.0);
    }
    //#endregion
