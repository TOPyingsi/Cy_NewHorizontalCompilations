...
@ccclass('SJZXD_AttackPatternButtom')
export class SJZXD_AttackPatternButtom extends Component {
    ...
    OnClick() {
        ...
        director.getScene().emit(SJZXD_EventManager.攻击模式切换, this._AttackPattern);
    }
