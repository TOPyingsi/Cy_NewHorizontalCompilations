...
@ccclass('SJZXD_AdvanceEvacuatePanel')
export class SJZXD_AdvanceEvacuatePanel extends PanelBase {
    Show(...args: any[]): void {
    ...
    OnButtonClick(event: EventTouch) {
        ...
        switch (event.target.name) {
            case "关闭":
                SJZXD_UIManager.Instance.HidePanel(SJZXD_Constant.Panel.AdvanceEvacuatePanel);
                break;
            case "取消":
                SJZXD_UIManager.Instance.HidePanel(SJZXD_Constant.Panel.AdvanceEvacuatePanel);
                break;
