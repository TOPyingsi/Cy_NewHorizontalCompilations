...
export class SJZXD_Constant {
    ...
    public static PropData: SJZXD_PropDataItem[] = [
        ...
        { Name: "户外耳机帽", price: 5000, quality: SJZXD_Quality.绿色, weight: 5, type: SJZXD_PropType.头盔, description: "带有耳机的户外帽子，提供基础听力保护，减少噪音干扰。", property: 800 }, // 头盔属性为生命
        { Name: "轻型头盔", price: 30000, quality: SJZXD_Quality.绿色, weight: 5, type: SJZXD_PropType.头盔, description: "轻型防护头盔，提供基本头部保护，不影响视野。", property: 900 }, // 头盔属性为生命
        { Name: "防弹头盔", price: 3000000, quality: SJZXD_Quality.蓝色, weight: 5, type: SJZXD_PropType.头盔, description: "标准防弹头盔，可有效抵御子弹和碎片伤害。", property: 1100 }, // 头盔属性为生命
        { Name: "MC防弹头盔", price: 5000000, quality: SJZXD_Quality.蓝色, weight: 5, type: SJZXD_PropType.头盔, description: "迷彩防弹头盔，具有良好的隐蔽性，提供中等防护。", property: 1250 }, // 头盔属性为生命
        { Name: "战术头盔", price: 18000000, quality: SJZXD_Quality.紫色, weight: 5, type: SJZXD_PropType.头盔, description: "高级战术头盔，集成了通讯和瞄准系统，提供全方位防护。", property: 1350 }, // 头盔属性为生命
        { Name: "SAS战术头盔", price: 25000000, quality: SJZXD_Quality.紫色, weight: 5, type: SJZXD_PropType.头盔, description: "特种部队专用头盔，防护性能卓越，具备夜视功能。", property: 1500 }, // 头盔属性为生命
        { Name: "MF防爆头盔", price: 40000000, quality: SJZXD_Quality.金色, weight: 5, type: SJZXD_PropType.头盔, description: "防爆专用头盔，可抵御爆炸冲击波和碎片伤害。", property: 1600 }, // 头盔属性为生命
        { Name: "精锐头盔", price: 50000000, quality: SJZXD_Quality.金色, weight: 5, type: SJZXD_PropType.头盔, description: "重型防护头盔，提供最高级别的头部保护，但会降低移动速度。", property: 1800 }, // 头盔属性为生命
        ...
        { Name: "轻型战术背心", price: 8000, quality: SJZXD_Quality.绿色, weight: 5, type: SJZXD_PropType.防具, description: "轻型战术背心，提供基础防护，不影响行动灵活性。", property: 450 }, // 防具属性为防御
        { Name: "通用战术背心", price: 50000, quality: SJZXD_Quality.绿色, weight: 5, type: SJZXD_PropType.防具, description: "通用战术背心，平衡防护和机动性，适合常规作战。", property: 500 }, // 防具属性为防御
        { Name: "快拆防弹衣", price: 4000000, quality: SJZXD_Quality.蓝色, weight: 5, type: SJZXD_PropType.防具, description: "快拆式防弹衣，紧急情况下可快速脱卸，提供中等防护。", property: 550 }, // 防具属性为防御
        { Name: "MC轻型防弹衣", price: 6000000, quality: SJZXD_Quality.蓝色, weight: 5, type: SJZXD_PropType.防具, description: "迷彩轻型防弹衣，具有良好的隐蔽性，适合野外作战。", property: 600 }, // 防具属性为防御
        { Name: "作战防弹衣", price: 24000000, quality: SJZXD_Quality.紫色, weight: 5, type: SJZXD_PropType.防具, description: "专业作战防弹衣，提供高级防护，内置战术装备挂载系统。", property: 650 }, // 防具属性为防御
        { Name: "Gen4作战防弹衣", price: 30000000, quality: SJZXD_Quality.紫色, weight: 5, type: SJZXD_PropType.防具, description: "第四代作战防弹衣，采用先进材料，防护性能卓越。", property: 700 }, // 防具属性为防御
        { Name: "MF重型防弹衣", price: 60000000, quality: SJZXD_Quality.金色, weight: 5, type: SJZXD_PropType.防具, description: "重型防弹衣，提供最高级别的防护，适合高风险作战环境。", property: 800 }, // 防具属性为防御
        { Name: "重型突击防弹衣", price: 80000000, quality: SJZXD_Quality.金色, weight: 5, type: SJZXD_PropType.防具, description: "突击专用重型防弹衣，防护和机动性完美结合。", property: 900 }, // 防具属性为防御
