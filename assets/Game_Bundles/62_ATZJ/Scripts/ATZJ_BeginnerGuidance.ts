...
@ccclass('ATZJ_BeginnerGuidance')
export class ATZJ_BeginnerGuidance extends Component {
    ...
    start() {
        ...
        this.Include(0);
        ATZJ_EasyController.on(ATZJ_EasyControllerEvent.角色选择框选中, () => { this.Include(1); }, this);
        ATZJ_EasyController.on(ATZJ_EasyControllerEvent.选中角色, () => { this.Include(2); }, this);
        ATZJ_EasyController.on(ATZJ_EasyControllerEvent.通灵选择框选中, () => { this.Include(3); }, this);
        ATZJ_EasyController.on(ATZJ_EasyControllerEvent.选中通灵, () => { this.Include(4); }, this);
        ATZJ_EasyController.on(ATZJ_EasyControllerEvent.角色选择框选中, () => { this.Include(5); }, this);
    }
    ...
    //关闭引导
    Exit() {
        ATZJ_GameData.Instance.GameData[2] = 1;//完成新手引导
