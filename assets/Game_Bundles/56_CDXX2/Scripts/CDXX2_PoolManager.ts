...
//“对象池管理器”单例统一维护所有 NodePool，提供预加载、取节点、回收、清理等接口，避免频繁 instantiate/destroy，提升运行时性能。

@ccclass('CDXX2_PoolManager')
export class CDXX2_PoolManager extends Component {
    public static Instance: CDXX2_PoolManager = null;


    protected onLoad(): void {
        CDXX2_PoolManager.Instance = this;
    }
