...
@ccclass('XSHZ_Constant')
export class XSHZ_Constant {
    ...
    public static UnitData: { Name: string, Speed: number, HP: number, Attack: number }[] = [
        ...
        { Name: "艾斯", Speed: 24, HP: 650, Attack: 13 },
