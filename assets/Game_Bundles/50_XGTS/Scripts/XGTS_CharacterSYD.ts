...
@ccclass('XGTS_CharacterSYD')
export default class XGTS_CharacterSYD extends XGTS_CharacterController {
    ...
    RefreshEquip() {
        let weaponData = XGTS_DataManager.ItemDataMap.get(XGTS_ItemType.Weapon).find(e => e.Name == "M249");
        //5.56x45mm M9
