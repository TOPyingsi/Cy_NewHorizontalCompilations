...
@ccclass('XGTS_CharacterEnemy')
export default class XGTS_CharacterEnemy extends XGTS_CharacterController {
    ...
    RefreshEquip() {
        this.weapon = XGTS_DataManager.ItemDataMap.get(XGTS_ItemType.Weapon).find(e => e.Name == "野牛");
        let ammo = XGTS_DataManager.GetItemDataByType(XGTS_ItemType.Ammo, 51314);
