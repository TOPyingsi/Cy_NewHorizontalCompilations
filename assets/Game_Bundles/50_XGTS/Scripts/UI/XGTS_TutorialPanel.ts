...
@ccclass('XGTS_TutorialPanel')
export default class XGTS_TutorialPanel extends PanelBase {
    Panel: Node = null;
    Pages: Node = null;
    ...
    OnButtonClick(event: Event) {
        ...
        switch (event.target.name) {
            case "ClosePageButton":
                XGTS_UIManager.Instance.HidePanel(XGTS_Constant.Panel.TutorialPanel);
