...
@ccclass('XGTS_ArrowGuide')
export class XGTS_ArrowGuide extends Component {
    Arrow: Node = null;
    ...
    protected onLoad(): void {
        ...
        this.HIDE_TUTORIAL();
        EventManager.on(XGTS_Constant.Event.SHOW_TUTORIAL, this.SHOW_TUTORIAL, this);
        EventManager.on(XGTS_Constant.Event.HIDE_TUTORIAL, this.HIDE_TUTORIAL, this);
    }
