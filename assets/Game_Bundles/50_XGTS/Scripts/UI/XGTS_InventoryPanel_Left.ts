...
@ccclass('XGTS_InventoryPanel_Left')
export default class XGTS_InventoryPanel_Left extends PanelBase {
    playerNum: number = 0;
    Content: Node = null;
    ...
    OnButtonClick(event: Event) {
        ...
        switch (event.target.name) {
            ...
            case "Weapon_BodyArmor":
                ...
                break;
            case "ReturnButton":
                XGTS_UIManager.Instance.HidePanel(XGTS_Constant.Panel.InventoryPanel_Left);
                break;
        }
    }
