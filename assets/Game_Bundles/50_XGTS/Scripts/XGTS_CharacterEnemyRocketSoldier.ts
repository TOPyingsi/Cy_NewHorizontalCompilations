...
import XGTS_Missile from './XGTS_Missile';
import { XGTS_Audio, XGTS_AudioManager } from './XGTS_AudioManager';

const v3_0 = v3();
const v3_1 = v3();

@ccclass('XGTS_CharacterEnemyRocketSoldier')
export default class XGTS_CharacterEnemyRocketSoldier extends XGTS_CharacterController {
    ...
    InitDeadBox() {
        ...
        let node = XGTS_PoolManager.Instance.Get(XGTS_Constant.Prefab.Supplies, XGTS_LvManager.Instance.Layer_Supplies);
    ...
    StartFire() {
        ...
        if (this.fireCooldown >= this.cooldown) {
            ...
            XGTS_AudioManager.Instance.PlaySFX(XGTS_Audio.MissileFire);

            this.scheduleOnce(() => {
                this.StopAni(1);
            }, 0.5);
            let missile = XGTS_PoolManager.Instance.Get(XGTS_Constant.Prefab.Missile, XGTS_LvManager.Instance.Game);
            ...
            missile.getComponent(XGTS_Missile).Init(this);
            this.fireCooldown = 0;
        }
    }
