...
@ccclass('XGTS_AudioManager')
export class XGTS_AudioManager extends Component {
    public static Instance: XGTS_AudioManager = null;
    ...
    protected onLoad(): void {
        XGTS_AudioManager.Instance = this;
    ...
    public PlayBGM(audio: XGTS_Audio): void {
    ...
    public PlaySFX(audio: XGTS_Audio, volumeScale: number = 1): void {
        let clip = this.clips.find(e => e.name == audio);
        if (clip) {
