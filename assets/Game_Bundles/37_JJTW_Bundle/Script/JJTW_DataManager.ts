...
export class JJTW_DataManager {
    private static instance: JJTW_DataManager;

    public static get Instance(): JJTW_DataManager {
        if (!JJTW_DataManager.instance) {
            JJTW_DataManager.instance = new JJTW_DataManager();
        }
        return JJTW_DataManager.instance;
    }
