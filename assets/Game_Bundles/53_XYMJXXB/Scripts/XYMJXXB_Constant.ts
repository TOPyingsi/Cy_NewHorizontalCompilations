...
@ccclass('XYMJXXB_Constant')
export class XYMJXXB_Constant {
    //难度
    ...
    public static PropData: { Name: string, type: string, value: number, quality: string, describe: string }[] = [
        ...
        { Name: '凡品丹药_普通', type: '回收物', value: 19999, quality: '白', describe: "食用后增加1点生命上限" },
        { Name: '凡品丹药_优质', type: '回收物', value: 39999, quality: '白', describe: "食用后增加2点生命上限" },
        { Name: '凡品丹药_顶级', type: '回收物', value: 99999, quality: '紫', describe: "食用后增加3点生命上限" },
        { Name: '凡品丹药_极品', type: '回收物', value: 309999, quality: '紫', describe: "食用后增加5点生命上限" },
        { Name: '凡品丹药_超级', type: '回收物', value: 509999, quality: '金', describe: "食用后增加7点生命上限" },
        { Name: '灵品丹药', type: '回收物', value: 1009999, quality: '金', describe: "食用后增加10点生命上限" },
        { Name: '圣品丹药', type: '回收物', value: 2009999, quality: '红', describe: "食用后增加0.1%攻速" },
        { Name: '帝品丹药', type: '回收物', value: 3009999, quality: '红', describe: "食用后增加0.1%移速" },
        { Name: '仙品丹药', type: '回收物', value: 5009999, quality: '炫彩', describe: "食用后增加0.5%攻速" },
        { Name: '神品丹药', type: '回收物', value: 10009999, quality: '炫彩', describe: "食用后增加0.5%移速" },
    ...
    public static GetDataByName(Name: string): { Name: string, type: string, value: number, quality: string, describe: string } {
        for (let i = 0; i < XYMJXXB_Constant.PropData.length; i++) {
            if (XYMJXXB_Constant.PropData[i].Name == Name) {
                return XYMJXXB_Constant.PropData[i];
            }
        }
    ...
    public static GetWeaponDataByName(Name: string): { Name: string, Attack: number, AttackSpeed: number } {
        for (let i = 0; i < XYMJXXB_Constant.WeaponData.length; i++) {
            if (XYMJXXB_Constant.WeaponData[i].Name == Name) {
                return XYMJXXB_Constant.WeaponData[i];
            }
        }
        console.log("名字错误，没有找到对应属性");
        return null;
    ...
    // 获取所有丹药类道具
    public static GetPillData(): { Name: string, type: string, value: number, quality: string, describe: string }[] {
        return XYMJXXB_Constant.PropData.filter(item =>
            item.Name.includes('丹药') || item.Name.startsWith('凡品丹药')
        );
    }

    // 随机获取一个丹药类道具
    public static GetRandomPill(): { Name: string, type: string, value: number, quality: string, describe: string } {
        const pills = this.GetPillData();
