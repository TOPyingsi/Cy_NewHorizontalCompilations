...
@ccclass('MTRNX_Water_TipPanel_Main')
export class MTRNX_Water_TipPanel_Main extends Component {
    panel: Node = null;
    titleLb: Label = null!;
    descLb: Label = null!;
    func: Function = null!;
    ...
    OnCloseButtonClick() {
        director.resume();
        MTRNX_Water_UIManager.Instance.HidePanel(MTRNX_Water_Panel.TipPanel);
    }
}