...
@ccclass('MTRNX_Water_BloodBar_Mtr')
export class MTRNX_Water_BloodBar_Mtr extends Component {
    ...
    Init(scale: Vec3 = Vec3.ONE) {
        ...
        this.ResetScale();
        this.node.setPosition(0, this.node.parent.getComponent(BoxCollider2D).size.height + MTRNX_Water_ZTool.GetRandom(10, 25));
        this.SetBar(1);
    }
