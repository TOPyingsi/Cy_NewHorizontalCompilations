...
@ccclass('MTRNX_Water_JiGuangJianKonRen')
export class MTRNX_Water_JiGuangJianKonRen extends MTRNX_Water_Unit {
    @property(Prefab)
    Bullet: Prefab = null;
    ...
    Biu() {
        ...
        this.scheduleOnce(() => {
            ...
            if (this.IsBeginAttack && this.TargetNodes.length > 0) {
                MTRNX_Water_AudioManager.AudioClipPlay("蓝色子弹发射", 0.25);
                ...
                pre.getComponent(MTRNX_Water_WBullet).init(this.TargetNodes[0], atk, this.BulletSpeed, this.IsEnemy, true, linearVelocity);
