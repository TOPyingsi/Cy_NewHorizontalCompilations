...
import { MTRNX_Water_WBullet3 } from '../MTRNX_Water_WBullet3';
const { ccclass, property } = _decorator;

@ccclass('MTRNX_Water_MiCaiMaTong')
export class MTRNX_Water_MiCaiMaTong extends MTRNX_Water_Unit {
    @property(Prefab)
    Bullet: Prefab = null;
    ...
    Attackincident() {
        if (this.TargetNodes.length > 0) {
            ...
            pre.getComponent(MTRNX_Water_WBullet3).IsAttack = false;
            ...
            pre.getComponent(MTRNX_Water_WBullet3).init(this.TargetNodes[0], this.attack, this.BulletSpeed, this.IsEnemy, false, linearVelocity);
