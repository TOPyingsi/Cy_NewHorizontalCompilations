...
@ccclass('MTRNX_Water_RenXinChonFengGe')
export class MTRNX_Water_RenXinChonFengGe extends MTRNX_Water_Unit {
    ...
    Attack() {
        ...
        if (this.IsStop == false) {
            ...
            if (this.TargetNodes.length > 0) {
                this.TargetNodes[0].getComponent(MTRNX_Water_Unit).Hurt(200);
            }
            this.speedBase = 4;
        }
        //这里只是播放攻击动画
