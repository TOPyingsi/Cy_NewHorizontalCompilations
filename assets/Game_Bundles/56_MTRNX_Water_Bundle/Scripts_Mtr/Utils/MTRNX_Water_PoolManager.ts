...
import MTRNX_Water_Singleton from "./MTRNX_Water_Singleton";
const { ccclass, property } = _decorator;

@ccclass("MTRNX_Water_PoolManager")
export class MTRNX_Water_PoolManager extends MTRNX_Water_Singleton {

    private static _instance: MTRNX_Water_PoolManager = null;
    public static get Instance() {
        if (!this._instance) {
            this._instance = new MTRNX_Water_PoolManager();
        }
