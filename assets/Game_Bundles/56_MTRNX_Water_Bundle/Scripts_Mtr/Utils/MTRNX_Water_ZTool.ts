...
@ccclass('MTRNX_Water_ZTool')
export class MTRNX_Water_ZTool extends Component {
    ...
    public static Shaking(node: Node, gap: number, randomMax: number, stopTime: number, callback: Function = null) {
        ...
        tween(node)
            .to(gap, { worldPosition: v3(x + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), y + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), y + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), y + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), y + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), z) })
            .to(gap, { worldPosition: v3(x + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), y + MTRNX_Water_ZTool.GetRandom(-randomMax, randomMax), z) })
   ...
   */
    ...
    public static DeepCopy<T>(obj: T) {
        ...
        if (Array.isArray(obj)) {
            ...
            for (let i = 0; i < obj.length; i++) {
                arrayCopy[i] = MTRNX_Water_ZTool.DeepCopy(obj[i]);
            }
        ...
        for (const key in obj) {
            if (obj.hasOwnProperty(key)) {
                objCopy[key] = MTRNX_Water_ZTool.DeepCopy(obj[key]);
            }
        }
        return objCopy as T;
    }
    ...
    */
    public static checkIsLowPhone() {
        ...
        return Number(MTRNX_Water_ZTool.getBenchmarkLevel()) < checkBenchmark;
    }
