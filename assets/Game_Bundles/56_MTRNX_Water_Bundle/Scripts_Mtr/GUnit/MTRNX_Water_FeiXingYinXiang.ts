...
@ccclass('MTRNX_Water_FeiXingYinXiang')
export class MTRNX_Water_FeiXingYinXiang extends MTRNX_Water_Unit {
    ...
    Attackincident() {
        ...
        if (this.TargetNodes.length > 0) {
            ...
            MTRNX_Water_ResourceUtil.LoadPrefab("Bullet/Gbullet2").then((prefab: Prefab) => {
                ...
                bullet.getComponent(MTRNX_Water_Gbullet).init(targetPoint, v2(this.node.getScale().x, 0), this.attack, 40, this.IsEnemy, true, 1, true, true);
