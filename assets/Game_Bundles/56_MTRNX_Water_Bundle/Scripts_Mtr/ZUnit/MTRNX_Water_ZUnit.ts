...
import { MTRNX_Water_SkillCD } from './MTRNX_Water_SkillCD';
const { ccclass, property } = _decorator;

@ccclass('MTRNX_Water_ZUnit')
export class MTRNX_Water_ZUnit extends MTRNX_Water_Unit {
    ...
    attackList: MTRNX_Water_Unit[] = [];
    shootList: MTRNX_Water_Unit[] = [];
    skillList: MTRNX_Water_Unit[] = [];
    suckList: MTRNX_Water_Unit[] = [];
    boomList: MTRNX_Water_Unit[] = [];
    ...
    start() {
        ...
        BundleManager.GetBundle("56_MTRNX_Water_Bundle").load("Prefabs/UI/BloodBar", Prefab, (err, res) => {
            ...
            let blood = MTRNX_Water_PoolManager.Instance.GetNode(res, this.node) as Node;
            ...
            blood.getComponent(MTRNX_Water_BloodBar_Mtr).Init(scale);
        ...
        this.schedule(() => { this.skillCD++ }, 1);
        this.schedule(() => { if (this.node.name == "Gman" && this.Hp > 0) MTRNX_Water_AudioManager.AudioClipPlay("Gman小曲") }, 5);
    ...
    EnterSKillCD(skillIndex: number) {
        this.CleanTarget();
        this.State = 1;
        MTRNX_Water_GameManager.Instance.UI.getChildByPath(this.Btns[skillIndex] + "/Mask").getComponent(MTRNX_Water_SkillCD).Init(skillIndex);
    }
    ...
    onBeginContact(selfCollider: Collider2D, otherCollider: Collider2D, contact: IPhysics2DContact | null) {
        ...
        if (other.getComponent(MTRNX_Water_Unit)) {
            var otherUnit = other.getComponent(MTRNX_Water_Unit);
    ...
    BContactEnd(otherUnit: MTRNX_Water_Unit) { }
    ...
    EContactEnd(otherUnit: MTRNX_Water_Unit) { }
    ...
    Die(): void {
        ...
        if (this.IsEnemy) MTRNX_Water_GameManager.Instance.haveHero = false;
        this.State = 2;
        ...
        if (this.IsMassacreUnit) {
            MTRNX_Water_GameManager.Instance.GameFail();
        }
    }
