...
export enum MTRNX_Water_Panel {
    PrivacyPanel = "Prefabs/UI/PrivacyPanel_Main",
    SelectLvPanel = "Prefabs/UI/MTRNX_Water_SelectLvPanel",
    GamePanel = "Prefabs/UI/MTRNX_Water_GamePanel_Mtr",
    LoadingPanel = "Prefabs/UI/MTRNX_Water_LoadingPanel",
    DialogPanel = "Prefabs/UI/MTRNX_Water_DialogPanel_Mtr",
    TipPanel = "Prefabs/UI/MTRNX_Water_TipPanel_Main",
    RewardPanel = "Prefabs/UI/MTRNX_Water_RewardPanel",
    Shopping = "Prefabs/UI/MTRNX_Water_Shoping",
    ChallengePanel = "Prefabs/UI/MTRNX_Water_ChallengePanel",
    miniGameSelect = "Prefabs/UI/MTRNX_Water_miniGameSelect",
    SuperShop = "Prefabs/UI/MTRNX_Water_SuperShop",
    LotteryPanel = "Prefabs/UI/MTRNX_Water_LotteryPanel",
    acquireMoneyPanel = "Prefabs/UI/MTRNX_Water_acquireMoneyPanel",
    acquireDebrisPanel = "Prefabs/UI/MTRNX_Water_acquireDebrisPanel",
    evolutionPanel = "Prefabs/UI/MTRNX_Water_evolutionPanel",
    limitPanel = "Prefabs/UI/MTRNX_Water_limitPanel",
    SeletGamePanel = "Prefabs/UI/MTRNX_Water_SeletGamePanel",
}

@ccclass('MTRNX_Water_UIManager')
export class MTRNX_Water_UIManager extends Component {
    private static _instance: MTRNX_Water_UIManager = null;
    public static get Instance() {
        if (!this._instance) {
            this._instance = new MTRNX_Water_UIManager();
        }
    ...
    public ShowPanel(panelPath: MTRNX_Water_Panel, args?: any, cb?: Function) {
        ...
        MTRNX_Water_ResourceUtil.LoadUI(panelPath, (err: any, node: any) => {
            //判断是否有可能在显示前已经被关掉了？
    ...
    Treasure_box() {
        ...
        BundleManager.GetBundle("56_MTRNX_Water_Bundle").load("Prefabs/UI/宝箱", Prefab, (err, event) => {
            if (err) {
